...
class MpesaConfig(models.Model):
    ...
    def _get_access_token(self):
        ...
        try:
            ...
            _logger.error(f'Failed to get M-Pesa access token: {str(e)}')
    ...
    def action_register_urls(self):
        ...
        try:
            ...
            _logger.error(f'Failed to register C2B URLs: {str(e)}')
    ...
    def initiate_stk_push(self, phone_number, amount, account_reference, description, invoice_id=None):
        ...
        try:
            ...
            _logger.error(f'Failed to initiate STK Push: {str(e)}')
    ...
    def query_stk_status(self, checkout_request_id):
        ...
        try:
            ...
            _logger.error(f'Failed to query STK status: {str(e)}')
