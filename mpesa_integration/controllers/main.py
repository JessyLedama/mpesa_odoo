...
class MpesaController(http.Controller):
    ...
    def c2b_validation(self, **kwargs):
        ...
        try:
            ...
            _logger.info('M-Pesa C2B Validation received: %s', data)
            ...
            _logger.error('M-Pesa C2B Validation error: %s', str(e))
            return {
                'ResultCode': 1,
                'ResultDesc': str(e)
            }
    ...
    def c2b_confirmation(self, **kwargs):
        ...
        try:
            data = request.jsonrequest
            _logger.info('M-Pesa C2B Confirmation received: %s', data)
            ...
            _logger.error('M-Pesa C2B Confirmation error: %s', str(e))
            return {
                'ResultCode': 1,
                'ResultDesc': str(e)
            }
    ...
    def stk_push_callback(self, **kwargs):
        ...
        try:
            data = request.jsonrequest
            _logger.info('M-Pesa STK Push Callback received: %s', data)
            ...
            _logger.error('M-Pesa STK Push Callback error: %s', str(e))
            return {
                'ResultCode': 1,
                'ResultDesc': str(e)
            }
    ...
    def result_callback(self, **kwargs):
        ...
        try:
            data = request.jsonrequest
            _logger.info('M-Pesa Result Callback received: %s', data)
            ...
            _logger.error('M-Pesa Result Callback error: %s', str(e))
            return {
                'ResultCode': 1,
                'ResultDesc': str(e)
            }
    ...
    def timeout_callback(self, **kwargs):
        ...
        try:
            data = request.jsonrequest
            _logger.info('M-Pesa Timeout Callback received: %s', data)
            ...
            _logger.error('M-Pesa Timeout Callback error: %s', str(e))
            return {
                'ResultCode': 1,
                'ResultDesc': str(e)
            }
